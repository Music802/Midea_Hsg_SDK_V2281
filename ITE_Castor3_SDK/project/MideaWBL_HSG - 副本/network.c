...
void NetworkInit(void)
{
    ...
    networkSocket = -1;
#ifdef CFG_NET_WIFI
   snprintf(gWifiSetting.ssid , WIFI_SSID_MAXLEN, "TP-LINK_2DA3");
   snprintf(gWifiSetting.password, WIFI_PASSWORD_MAXLEN, "itepassword");
   snprintf(gWifiSetting.secumode, WIFI_SECUMODE_MAXLEN,"3");
     printf("Networkinit\r\n");
	 printf("SSID=%s\r\n",gWifiSetting.ssid);
	 printf("Password=%s\r\n",gWifiSetting.password);
	 printf("Security Mode=%s\r\n",gWifiSetting.secumode);	 
