...
#Kenny add for HSG
if (DEFINED CFG_SPI_LCD_800X480_NT35510)
    add_definitions(
        -DCFG_SPI_LCD_800X480_NT35510
    )
endif()
if (DEFINED CFG_SPI_LCD_800X480_RM68180)
    add_definitions(
        -DCFG_SPI_LCD_800X480_RM68180
    )
endif()
if (DEFINED CFG_SPI_LCD_800X480_OTM8019A)
    add_definitions(
        -DCFG_SPI_LCD_800X480_OTM8019A
    )
endif()
...
if (DEFINED  CFG_SPI_LCD_800X480_DX040B043)
    add_definitions(
        -DCFG_SPI_LCD_800X480_DX040B043
    )
endif()
if (DEFINED CFG_SPI_LCD_854X480_RM7701)
    add_definitions(
        -DCFG_SPI_LCD_854X480_RM7701
    )
endif()
if (DEFINED CFG_SPI_LCD_854X480_ST7701_DX050C023)
    add_definitions(
        -DCFG_SPI_LCD_854X480_ST7701_DX050C023
    )
endif()
...
if (DEFINED CFG_GPIO_WIFI_SWITCH)
    add_definitions(
        -DCFG_GPIO_WIFI_SWITCH=${CFG_GPIO_WIFI_SWITCH}
    )
endif()
if (DEFINED CFG_GPIO_AUDIO_AMP_POWER)
    add_definitions(
        -DCFG_GPIO_AUDIO_AMP_POWER=${CFG_GPIO_AUDIO_AMP_POWER}
    )
endif()
if (DEFINED CFG_SD_POWER_RESET_ACTIVE_LOW)
    add_definitions(
        -DCFG_SD_POWER_RESET_ACTIVE_LOW
    )
endif()
if (DEFINED CFG_MIDEA_HSG_SPECIAL_SET)
    add_definitions(
        -DCFG_MIDEA_HSG_SPECIAL_SET
    )
endif()
